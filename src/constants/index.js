...
const experiences = [
  {
    ...
    company_name: "Cambio Software Engineering",
    icon: cambio,
    iconBg: "#E6DEDD",
    date: "Jan 2024 - Current",
    points: [
      "Contribute to the development and enhancement of Min Hälsa (My Health) app, focusing on improving user experience and adding new features.",
      "Gain hands-on experience with state management using Bloc and Cubit in Flutter for building responsive and maintainable mobile applications.",
      "Apply TDD principles to ensure code quality and reliability by writing tests before implementing functionality.",
      "Utilize Bitbucket and Git for version control, managing code repositories, and collaborating with team members on code changes and reviews.",
      "Participate in Agile processes, including daily stand-ups, sprint planning, and retrospectives, to enhance team coordination and project management.",
      "Engage in sprint cycles to deliver incremental improvements and manage project timelines effectively.",
    ],
  },
  {
